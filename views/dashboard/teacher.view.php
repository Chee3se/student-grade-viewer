<?php component('header'); ?>
        ...
        <div class="bg-white rounded-lg shadow-sm border mb-8">
            <div class="p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center">
                <div>
                    ...
                    <p class="text-gray-600" id="teacherName">Skolotājs: Jānis Bērziņš</p>
                </div>
    ...
    <script>
        // DEMO DATA
        const teacher = { first_name: "Jānis", last_name: "Bērziņš" };
        const students = [
            { id: 1, first_name: "Anna", last_name: "Ozoliņa" },
            { id: 2, first_name: "Pēteris", last_name: "Kalniņš" }
        ];
        const subjects = [
            { id: 1, name: "Matemātika" },
            { id: 2, name: "Latviešu valoda" }
        ];
        const grades = [
            { student_id: 1, subject_id: 1, grade: 8 },
            { student_id: 1, subject_id: 2, grade: 9 },
            { student_id: 2, subject_id: 1, grade: 7 },
            { student_id: 2, subject_id: 2, grade: 10 }
        ];
        ...
        function renderGrades() {
            ...
            grades.forEach(grade => {
                ...
                tr.setAttribute('data-student', grade.student_id);
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm text-right font-medium">${grade.grade}</td>
      `;
